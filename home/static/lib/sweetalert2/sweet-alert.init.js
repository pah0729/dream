...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sa-success2').click(function () {
            Swal.fire("성공!", "등록되었습니다.", "success");

        });

        $('#sa-success3').click(function () {
            Swal.fire("성공!", "작성되었습니다.", "success");
        ...
        $("#sa-bg").click(function () {
            Swal.fire({
                ...
                backdrop: ' rgba(0,0,123,0.4) url("../assets/images/background/nyan-cat.gif") center left no-repeat '
            })
        });
